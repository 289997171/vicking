...
public class QSkill
{
    ...
    //命中震屏效果
    public string qShakeType;

    //震屏延迟
    public string qShakeDelayTime;

    //技能持续特效编号
    public string qSeriesEffect;

    //命中点，以及被攻击特效播放位置1：头 2：胸 3：脚下
    public int qHitBindPos;
    ...
    //是否预警技能
    public int qIsWarning;

    //预警时间（毫秒）
    public int qWarningTime;

    //预警特效
    public int qWarningEffectid;

    //预警坐标类型（1.周围50个坐标刷新15个坐标）
    public int qWarningPosType;
